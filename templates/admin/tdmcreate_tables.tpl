...
<{if $modules_list}>
    <table class='tdm-table outer width100'>
        <thead>
            <tr>
                <th class='center cell width8'><{$smarty.const._AM_TDMCREATE_MODULE_ID}></th>
                <th class='center cell'><{$smarty.const._AM_TDMCREATE_MODULE_NAME_LIST}></th>
                <th class='center cell width8'><{$smarty.const._AM_TDMCREATE_MODULE_IMAGE_LIST}></th>
                <th class='center cell width5'><{$smarty.const._AM_TDMCREATE_MODULE_NBFIELDS_LIST}></th>
                <th class='center cell width5'><{$smarty.const._AM_TDMCREATE_MODULE_ADMIN_LIST}></th>
                <th class='center cell width5'><{$smarty.const._AM_TDMCREATE_MODULE_USER_LIST}></th>
                <th class='center cell width5'><{$smarty.const._AM_TDMCREATE_MODULE_BLOCKS_LIST}></th>
                <th class='center cell width8'><{$smarty.const._AM_TDMCREATE_MODULE_SUBMENU_LIST}></th>
                <th class='center cell width5'><{$smarty.const._AM_TDMCREATE_MODULE_SEARCH_LIST}></th>
                <th class='center cell width8'><{$smarty.const._AM_TDMCREATE_MODULE_COMMENTS_LIST}></th>
                <th class='center cell width8'><{$smarty.const._AM_TDMCREATE_MODULE_NOTIFICATIONS_LIST}></th>
                <th class='center cell width8'><{$smarty.const._AM_TDMCREATE_MODULE_PERMISSIONS_LIST}></th>
                <th class='center cell width6'><{$smarty.const._AM_TDMCREATE_FORMACTION}></th>
            </tr>
        </thead>
        <tbody>

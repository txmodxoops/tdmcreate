...
{
    $donationform = array(	0 => '<form name="donation" id="donation" action="http://www.txmodxoops.org/modules/xpayment/" method="post" onsubmit="return xoopsFormValidate_donation();">',

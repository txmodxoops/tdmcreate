...
define('_MI_TDMCREATE_ADMENU2', 'Settings');
...
//1.381
define('_MI_TDMCREATE_CONFIG_NAME', 'Module Name');
// Added in version 1.91
define('_MI_TDMCREATE_CONFIG_DIRNAME', 'Directory Name');
// ---------------------
define('_MI_TDMCREATE_CONFIG_VERSION', 'Module Version');
define('_MI_TDMCREATE_CONFIG_SINCE', 'Module Since');
define('_MI_TDMCREATE_CONFIG_AUTHOR', 'Module Author');
define('_MI_TDMCREATE_CONFIG_AUTHOR_EMAIL', "Author's Email");
define('_MI_TDMCREATE_CONFIG_AUTHOR_WEBSITE_URL', "Author's Website URL");
...
define('_MI_TDMCREATE_CONFIG_MANUAL', 'Modules Manual');
define('_MI_TDMCREATE_CONFIG_MANUAL_FILE', 'Manual file');
define('_MI_TDMCREATE_CONFIG_IMAGE', 'Modules Image');
define('_MI_TDMCREATE_CONFIG_DEMO_SITE_URL', 'Demo Website URL');
define('_MI_TDMCREATE_CONFIG_DEMO_SITE_NAME', 'Demo Website Name');
define('_MI_TDMCREATE_CONFIG_SUPPORT_URL', 'Support Website URL');
define('_MI_TDMCREATE_CONFIG_SUPPORT_NAME', 'Support Website');
define('_MI_TDMCREATE_CONFIG_WEBSITE_URL', 'Module website URL');
define('_MI_TDMCREATE_CONFIG_WEBSITE_NAME', 'Module Website name');
define('_MI_TDMCREATE_CONFIG_RELEASE_DATE', 'Release Date');
define('_MI_TDMCREATE_CONFIG_STATUS', 'Module status');
define('_MI_TDMCREATE_CONFIG_DISPLAY_ADMIN_SIDE', 'Visible in Admin Panel');
define('_MI_TDMCREATE_CONFIG_DISPLAY_USER_SIDE', 'Visible in User side');
// Added in version 1.91
define('_MI_TDMCREATE_CONFIG_ACTIVE_BLOCKS', 'Allow Blocks');
// ---------------------
define('_MI_TDMCREATE_CONFIG_ACTIVE_SEARCH', 'Allow Search');
define('_MI_TDMCREATE_CONFIG_ACTIVE_COMMENTS', 'Allow Comments');
define('_MI_TDMCREATE_CONFIG_ACTIVE_NOTIFICATIONS', 'Allow notifications');
define('_MI_TDMCREATE_CONFIG_ACTIVE_PERMISSIONS', 'Allow permissions');
define('_MI_TDMCREATE_CONFIG_INROOT_COPY', 'Copy this module also in root/modules?');
...
define('_MI_TDMCREATE_CONFIG_BREAK_OPTIONAL', 'Module optional');

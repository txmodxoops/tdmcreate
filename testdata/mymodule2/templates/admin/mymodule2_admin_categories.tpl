...
<{if $categories_list}>
	<table class='table table-bordered'>
		<thead>
			<tr class='head'>
				<th class="center"><{$smarty.const._AM_MYMODULE2_CATEGORY_ID}></th>
				<th class="center"><{$smarty.const._AM_MYMODULE2_CATEGORY_NAME}></th>
				<th class="center"><{$smarty.const._AM_MYMODULE2_CATEGORY_CREATED}></th>

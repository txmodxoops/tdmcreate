 ...
 * @return bool|null
 */
function xoops_module_update_mymodule2(&$module, $prev_version = null)
{
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_mymodule2_v10($module);
    }
 ...
 * @return bool
 */
function update_mymodule2_v10($module)
{
    global $xoopsDB;
...
function mymodule2_check_db($module)
{
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('mymodule2_images');
    $field   = 'img_exif';

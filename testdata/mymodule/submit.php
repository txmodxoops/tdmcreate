...
xoops_loadLanguage('admin', 'mymodule');
// It recovered the value of argument op in URL$
$op = Request::getString('op', 'form');
// Template
$GLOBALS['xoopsOption']['template_main'] = 'mymodule_submit.tpl';
include_once XOOPS_ROOT_PATH . '/header.php';
$GLOBALS['xoTheme']->addStylesheet( $style, null );
$permSubmit = $gpermHandler->checkRight('mymodule_ac', 4, $groups, $GLOBALS['xoopsModule']->getVar('mid')) ? true : false;
...
// Breadcrumbs
$xoBreadcrumbs[] = ['title' => _MA_MYMODULE_SUBMIT];

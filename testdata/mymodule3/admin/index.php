...
use XoopsModules\Mymodule3\Common;

include_once dirname(__DIR__) . '/preloads/autoloader.php';
require __DIR__ . '/header.php';

// Template Index
$templateMain = 'mymodule3_admin_index.tpl';
...
// InfoBox Statistics
$adminObject->addInfoBox(_AM_MYMODULE3_STATISTICS);
// Info elements
$adminObject->addInfoBoxLine(sprintf( '<label>'._AM_MYMODULE3_THEREARE_CATEGORIES.'</label>', $countCategories));
$adminObject->addInfoBoxLine(sprintf( '<label>'._AM_MYMODULE3_THEREARE_ARTICLES.'</label>', $countArticles));
$adminObject->addInfoBoxLine(sprintf( '<label>'._AM_MYMODULE3_THEREARE_TESTFIELDS.'</label>', $countTestfields));

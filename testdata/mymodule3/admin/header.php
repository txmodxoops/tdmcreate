...
$modPathIcon16   = MYMODULE3_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons16') . '/';
$modPathIcon32   = MYMODULE3_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons32') . '/';
...
$style = MYMODULE3_URL . '/assets/css/admin/style.css';

...
<table class="table table-<{$table_type}>">
    <thead>
        <tr class="center">
            <th><{$smarty.const._MA_MYMODULE3_TITLE}>  -  <{$smarty.const._MA_MYMODULE3_DESC}></th>
        </tr>
    </thead>
    <tbody>
        <tr class="center">
            <td class="bold pad5">
                <ul class="menu text-center">
                    <li><a href="<{$mymodule3_url}>"><{$smarty.const._MA_MYMODULE3_INDEX}></a></li>
                    <li><a href="<{$mymodule3_url}>/categories.php"><{$smarty.const._MA_MYMODULE3_CATEGORIES}></a></li>
                    <li><a href="<{$mymodule3_url}>/articles.php"><{$smarty.const._MA_MYMODULE3_ARTICLES}></a></li>
                    <li><a href="<{$mymodule3_url}>/testfields.php"><{$smarty.const._MA_MYMODULE3_TESTFIELDS}></a></li>
                </ul>
				<div class="justify pad5"><{$smarty.const._MA_MYMODULE3_INDEX_DESC}></div>
            </td>
        </tr>
    </tbody>
    <tfoot>
...
<div class="table-responsive">
    <table class="table table-<{$table_type}>">
		<thead>
			<tr>
				<th colspan="<{$numb_col}>"><{$smarty.const._MA_MYMODULE3_ARTICLES}></th>
			</tr>
		</thead>
		<tbody>
			<tr>
...
<{if $articlesCount > 0}>
	...
	<div class="mymodule3-linetitle"><{$smarty.const._MA_MYMODULE3_INDEX_LATEST_LIST}></div>
	<table class="table table-<{$table_type}>">
		<tr>
			<!-- Start new link loop -->
...
<div class="table-responsive">
    <table class="table table-<{$table_type}>">
		<thead>
			<tr>
				<th colspan="<{$numb_col}>"><{$smarty.const._MA_MYMODULE3_TESTFIELDS}></th>
			</tr>
		</thead>
		<tbody>
			<tr>

 ...
 * @return bool|null
 */
function xoops_module_update_mymodule3(&$module, $prev_version = null)
{
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_mymodule3_v10($module);
    }

    $ret = mymodule3_check_db($module);

    //check upload directory
	include_once __DIR__ . '/install.php';
    $ret = xoops_module_install_mymodule3($module);
 ...
 * @return bool
 */
function update_mymodule3_v10($module)
{
    global $xoopsDB;
 ...
 * @return bool
 */
function mymodule3_check_db($module)
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('mymodule3_images');
    $field   = 'img_exif';

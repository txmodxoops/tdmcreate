...
$GLOBALS['xoopsOption']['template_main'] = 'mymodule3_index.tpl';
...
if ($articlesCount > 0) {
	...
	$GLOBALS['xoopsTpl']->assign('lang_thereare', sprintf(_MA_MYMODULE3_INDEX_THEREARE, $articlesCount));
...
if ($testfieldsCount > 0) {
	...
	$GLOBALS['xoopsTpl']->assign('lang_thereare', sprintf(_MA_MYMODULE3_INDEX_THEREARE, $testfieldsCount));
	$GLOBALS['xoopsTpl']->assign('divideby', $helper->getConfig('divideby'));
	$GLOBALS['xoopsTpl']->assign('numb_col', $helper->getConfig('numb_col'));
}
unset($count);
$GLOBALS['xoopsTpl']->assign('table_type', $helper->getConfig('table_type'));
// Breadcrumbs
$xoBreadcrumbs[] = ['title' => _MA_MYMODULE3_INDEX];
// Keywords
mymodule3MetaKeywords($helper->getConfig('keywords').', '. implode(',', $keywords));
unset($keywords);
// Description
mymodule3MetaDescription(_MA_MYMODULE3_INDEX_DESC);
